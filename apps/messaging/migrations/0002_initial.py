    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.CASCADE,
                related_name="events",
                to="messaging.customerpreferences",
            ),
        ),
        migrations.AddField(
            model_name="consentevent",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="scheduled_m_tenant__b00130_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="scheduledmessage",
            index=models.Index(
                ...
                name="scheduled_m_tenant__7d6006_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="scheduledmessage",
            index=models.Index(
                fields=["status", "scheduled_at"], name="scheduled_m_status_c4bde9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="messagetemplate",
            index=models.Index(
                fields=["tenant", "message_type"], name="message_tem_tenant__54e8e0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="messagequeue",
            index=models.Index(
                fields=["conversation", "status", "queue_position"],
                name="message_que_convers_3f6b58_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="messagequeue",
            index=models.Index(
                fields=["status", "queued_at"], name="message_que_status_249332_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="messagequeue",
            index=models.Index(
                ...
                name="message_que_convers_1ab3ab_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="messagecampaign",
            index=models.Index(
                fields=["tenant", "status"], name="message_cam_tenant__00287c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="messagecampaign",
            index=models.Index(
                fields=["tenant", "created_at"], name="message_cam_tenant__9e1e0a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="messagecampaign",
            index=models.Index(
                fields=["status", "scheduled_at"], name="message_cam_status_13dfe3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="message",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="messages_convers_274d78_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="message",
            index=models.Index(
                fields=["provider_msg_id"], name="messages_provide_dbad94_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="message",
            index=models.Index(
                ...
                name="messages_message_b6f356_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="customerpreferences",
            index=models.Index(
                fields=["tenant", "customer"], name="customer_pr_tenant__d92829_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customerpreferences",
            index=models.Index(
                fields=["tenant", "promotional_messages"],
                name="customer_pr_tenant__edefca_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="customerpreferences",
            index=models.Index(
                fields=["tenant", "reminder_messages"],
                name="customer_pr_tenant__bda299_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tenant", "customer", "status"],
                name="conversatio_tenant__cbd727_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="conversation",
            index=models.Index(
                ...
                name="conversatio_tenant__625dfe_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="conversation",
            index=models.Index(
                fields=["tenant", "updated_at"], name="conversatio_tenant__c2ee7a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="conversation",
            index=models.Index(
                fields=["status", "updated_at"], name="conversatio_status_bbfab5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="consentevent",
            index=models.Index(
                ...
                name="consent_eve_tenant__6f601c_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="consentevent",
            index=models.Index(
                fields=["tenant", "consent_type", "created_at"],
                name="consent_eve_tenant__e79521_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="consentevent",
            index=models.Index(
                fields=["customer", "created_at"], name="consent_eve_custome_6b26cb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="campaignbuttoninteraction",
            index=models.Index(
                fields=["campaign", "clicked_at"], name="campaign_bu_campaig_c33923_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="campaignbuttoninteraction",
            index=models.Index(
                fields=["campaign", "button_id"], name="campaign_bu_campaig_61c583_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="campaignbuttoninteraction",
            index=models.Index(
                fields=["customer", "clicked_at"], name="campaign_bu_custome_edea06_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="campaignbuttoninteraction",
            index=models.Index(
                fields=["campaign", "led_to_conversion"],
                name="campaign_bu_campaig_b5f633_idx",
            ),
        ),
    ]
