        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "msgs_in",
                    models.IntegerField(
                        default=0, help_text="Number of inbound messages"
                    ),
                ),
                (
                    "msgs_out",
                    models.IntegerField(
                        default=0, help_text="Number of outbound messages"
                    ),
                ),
                (
                    "conversations",
                    models.IntegerField(
                        default=0, help_text="Number of new conversations started"
                    ),
                ),
                (
                ...
                (
                    "enquiries",
                    models.IntegerField(
                        default=0, help_text="Number of product/service enquiries"
                    ),
                ),
                (
                    "orders",
                    models.IntegerField(
                        default=0, help_text="Number of orders created"
                    ),
                ),
                (
                    "revenue",
                ...
                (
                    "bookings",
                    models.IntegerField(
                        default=0, help_text="Number of appointments booked"
                    ),
                ),
                (
                ...
                (
                    "campaign_sends",
                    models.IntegerField(
                        default=0, help_text="Number of campaign messages sent"
                    ),
                ),
                (
                    "campaign_responses",
                    models.IntegerField(
                        default=0, help_text="Number of responses to campaign messages"
                    ),
                ),
            ],
            options={
